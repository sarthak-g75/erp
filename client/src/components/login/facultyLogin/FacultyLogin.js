...
const FacultyLogin = () => {
  ...
  return (
    <div className='bg-[#5a51d6]  min-h-screen w-screen top-0 -z-10 absolute flex items-center justify-center'>
      <div className='grid grid-cols-2 p-12 shadow-2xl bg-slate-200 rounded-3xl'>
        ...
        >
          <h1 className='text-3xl font-semibold text-white'>Faculty</h1>
