...
const StudentLogin = () => {
  ...
  return (
    <div className='bg-[#d65158]  min-h-screen w-screen top-0 -z-10 absolute flex items-center justify-center'>
      <div className='grid grid-cols-2 p-12 shadow-2xl bg-slate-200 rounded-3xl'>
        ...
        <form
          ...
          } w-96 bg-[#2c2f35] flex flex-col items-center justify-center transition-all space-y-6 rounded-3xl shadow-2xl`}
        >
          <h1 className='text-3xl font-semibold text-white'>Student</h1>
